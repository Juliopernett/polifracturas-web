...
export default function About() {
  return (
    <div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-14 items-center">
          ...
          <div className="flex-1 pt-10 lg:pt-0">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#1E3A5F] mt-2 mb-6">Nuestra Historia</h2>
      ...
      {/* Misión y Visión — texto real */}
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#1E3A5F] text-white rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute -top-4 -right-4 text-[110px] opacity-5 leading-none select-none">🎯</div>
            <div className="text-4xl mb-4">🎯</div>
            <h2 className="text-2xl font-bold mb-4 text-[#00A896]">Misión</h2>
          ...
          <div className="bg-[#00A896] text-white rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute -top-4 -right-4 text-[110px] opacity-10 leading-none select-none">🔭</div>
            <div className="text-4xl mb-4">🔭</div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-[#1E3A5F] mt-2">Valores Corporativos</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {values.map(v => (
              ...
              >
                <div className="flex-shrink-0 text-4xl">{v.icon}</div>
                <div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-[#1E3A5F] mt-2">Objetivos Institucionales</h2>
          </div>
