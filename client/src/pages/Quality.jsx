    ...
    <div>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-14 shadow-xl">
          ...
          <div className="relative z-10 p-10 text-white">
            ...
            <p className="text-white/85 leading-relaxed">
              ...
              íntegra y sólida, altamente posicionada en nuestra comunidad, siendo reconocida por su{' '}
              <strong className="text-white">rentabilidad social</strong>.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
          {pillars.map(p => (
            <div key={p.title} className="bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-1 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
          ...
          <div className="bg-[#1E3A5F]/5 border border-[#1E3A5F]/15 rounded-2xl p-7">
            <h3 className="font-bold text-[#1E3A5F] text-lg mb-4 flex items-center gap-2">
              <span>📋</span> Cumplimiento Normativo
            </h3>
            <ul className="space-y-2 text-sm text-gray-700">
              {[
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={doc} className="flex items-center justify-between bg-white border border-gray-200 rounded-xl px-5 py-3.5 hover:border-[#00A896]/50 transition-colors">
